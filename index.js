...
//             // MODIFIED: Build query based on who is joining
//             let historyQuery = { room: roomName };
//             if (userId === 'admin_user') {
//                 historyQuery.clearedForAdmin = { $ne: true }; // Admin doesn't see admin-cleared messages
//             } else {
//                 historyQuery.clearedForUser = { $ne: true }; // User doesn't see user-cleared messages
//             }
...
//                 message: data.message,
//                 isRead: false
//                 // Note: clearedForUser and clearedForAdmin default to false in the model
//             });
//             await message.save();
//             io.to(data.room).emit('receive_message', message);
//             io.to(data.room).emit('new_message_notification', {
...
// This will run for any request that doesn't match the API routes above
...
// This will run if any of the route handlers call next(error)
