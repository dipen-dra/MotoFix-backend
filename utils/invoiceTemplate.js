        ...
        <div class="invoice-box">
                ...
                <tbody>
                    <tr class="item-row">
                        <td>
                            ...
                            ${booking.notes ? `<div class="item-description">Notes: ${booking.notes}</div>` : ''}
                        </td>
                    ...
                    <tr class="item-row">
                        <td>
                            ...
                            <div class="item-description">From: ${booking.pickupAddress || 'N/A'}</div>
                            <div class="item-description">To: ${booking.dropoffAddress || 'N/A'}</div>
                            <div class="item-description">Distance: ${booking.pickupDropoffDistance ? `${booking.pickupDropoffDistance.toFixed(2)} km` : 'N/A'}</div>
                        </td>
            ...
            <div class="totals">
                <table class="totals-table">
                    ...
                    <tr>
                        <td class="label">Discount (${booking.discountApplied ? '20%' : '0%'})</td>
